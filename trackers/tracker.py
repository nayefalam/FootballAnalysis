...
class Tracker:
    ...
    def getObjectTracks(self, frames, read_fom_stub = False, stub_path = None):

        if read_fom_stub and stub_path is not None and os.path.exists(stub_path):
        ...
        #for oevrriding the goalkeeper as a player itself:
    ...
    def draw_ellipse(self,frame,bbox,color,track_id=None):
        ...
        rectangleWidth = 40
        rectangleHeight = 20
        x1_rect = x_center - rectangleWidth//2
        x2_rect = x_center + rectangleWidth//2
        y1_rect = (y2 - rectangleHeight//2) + 15
        y2_rect = (y2 + rectangleHeight//2) + 15
    ...
    def draw_team_ball_control(self,frame,frame_num,team_ball_control):
        ...
        overlay = frame.copy()
        cv2.rectangle(overlay, (1350, 850), (1900,970), (231,155,100), -1 )
        alpha = 0.4
    ...
    def draw_annotations(self,video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                color = player.get("team_color",(100,0,255))
            ...
            for track_id, player in referee_dict.items():
                frame = self.draw_ellipse(frame, player["bbox"], (100,255,0))

            #Draw Ball
            for track_id,ball in ball_dict.items():
                frame = self.draw_triangle(frame, ball["bbox"], (243,255,130))
